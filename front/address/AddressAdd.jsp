...
<body>
			...
			<div class="weui-cells weui-cells_form">
				...
				<div class="weui-cell">
					...
					<div class="weui-cell__bd">
						...
						<input  name="mbr_id" class="weui-input" type="hidden" value="${user.id }">
				...
				<input hidden="hidden" id="default_value" name="default_value" type="radio" value="0" checked="checked" />
				<div class="weui-cell weui-cell_switch">
					<div class="weui-cell__bd">是否启用</div>
					<div class="weui-cell__ft">
						<input id="button1" name="button1" class="weui-switch" type="checkbox">
					</div>
				</div>
	...
	<button class="weui-btn  weui-btn_primary" type="submit">添加地址</button>
	</form>
