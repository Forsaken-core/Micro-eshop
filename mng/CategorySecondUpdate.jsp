				...
				<div class="col-md-12" style="float: left;">
					...
					<div class="box box-info" style="border-radius: 12px;">
						<div class="box-header with-border">
							<h3 class="box-title">编辑二级分类</h3>
						</div>
						<!-- /.box-header -->
						<!-- form start -->
						<form class="form-horizontal" action="CategorySecondUpdate.do" method="post"
							id="CategorySecondUpdate" enctype="multipart/form-data">
							<div class="box-body">
								...
								<div class="form-group">
									...
									<div class="col-sm-7">
										<input  type="text" class="form-control"
											id="name" name="name" placeholder="不能为空" value="${categorysecond.name }">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-7">
										<input type="text" class="form-control"
											id="alias" name="alias" placeholder="不能为空" value="${categorysecond.alias }">
									</div>
								</div>
								
								<div class="form-group">
										<label for="inputPassword3" class="col-sm-2 control-label">所属父类</label>
										<div class="col-sm-7">
								...
								<div class="form-group">
									...
									<div class="col-sm-7">
										<input type="text" class="form-control"
											id="sort" name="sort" placeholder="请在1，2中输入一个数字" value="${categorysecond.sort }">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-7">
										<label class="radio-inline"> <input type="radio"
											name="app_display" checked="checked" value="1" />是
										</label> <label class="radio-inline"> <input type="radio"
											name="app_display" value="0" />否
										</label>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-7">
										<textarea name="desca" class="col-sm-12" style="resize:none;" >${categorysecond.desca }</textarea>
									</div>
								</div>
									...
									<div class="col-sm-10">
										<div class="input-group">
											<input style="width: 300px;" type="file" id="thumbnail"
												name="thumbnail" value="请选择要上传图片" style="height: 43px;" value="${categorysecond.thumbnail }">
										</div>
									</div>
								</div>
...
<script type="text/javascript">
	$(document).ready(function() {
		$('#CategorySecondAdd').bootstrapValidator({
