			...
			<section class="content">
				...
				<div class="col-md-12" style="float:left;">
					...
					<div class="box box-info" style="border-radius: 12px;">
						...
						<!-- /.box-header -->
						<!-- form start -->
						<form class="form-horizontal" action="update.do" method="post" id="register" enctype="multipart/form-data">
							<div class="box-body">
								<div class="form-group">
									<label for="inputEmail3" class="col-sm-2 control-label">登录名</label>

									<div class="col-sm-10">
										<input style="width: 60%;" type="text" class="form-control" value="${member.username }"
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input style="width: 60%;" type="text" class="form-control"
											name="inputRealname" placeholder="中文、英文组成" value="${member.real_name }">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input style="width: 60%;" type="text" class="form-control"
											name="inputNickname" placeholder="中文、英文组成" value="${member.nick_name }">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input style="width: 60%;" type="text" class="form-control"
											name="inputNumber" placeholder="手机号、座机号" value="${member.mobile }">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input style="width: 60%;" type="text" class="form-control"
											name="inputEmail3" placeholder="建议使用QQ、163/126邮箱" value="${member.email }">
									</div>
								</div>
								...
								<div class="form-group">
									<label for="inputPassword3" class="col-sm-2 control-label">修改头像</label>
									<div class="col-sm-10">
