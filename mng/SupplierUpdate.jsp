		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				...
				<ol class="breadcrumb">
					...
					<li class="active"><a href="javascript:;">供应商编辑</a></li>
				</ol>
			</section>
			...
			<section class="content">
				...
				<div class="col-md-12" style="float:left;">
					...
					<div class="box box-info" style="border-radius: 12px;">
						...
						<!-- /.box-header -->
						<!-- form start -->
						<form class="form-horizontal" action="SupplierUpdate.do" method="post" id="SupplierUpdate">
							<div class="box-body">
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input style="width: 60%;" type="text" class="form-control"
											id="name" name="name" placeholder="请输入供应商名字" value="${supplier.name }">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input style="width: 60%;" type="text" class="form-control"
											id="code" name="code" placeholder="请输入供应商邮编" value="${supplier.code }">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input style="width: 60%;" type="text" class="form-control"
											id="address" name="address" placeholder="请输入供应商地址" value="${supplier.address }">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input style="width: 60%;" type="text" class="form-control"
											id="contact" name="contact" placeholder="请输入供应商联系人" value="${supplier.contact }">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input style="width: 60%;" type="text" class="form-control"
											name="tel" placeholder="手机号、座机号" value="${supplier.tel }">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input style="width: 60%;" type="text" class="form-control" id="email"
											name="email" placeholder="建议使用QQ、163/126邮箱" value="${supplier.email }">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input style="width: 60%;" type="text" class="form-control"
											id="remark" name="remark" placeholder="请输入备注" value="${supplier.remark }">
									</div>
								</div>
