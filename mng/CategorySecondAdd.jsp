			...
			<section class="content">
				...
				<div class="col-md-12" style="float: left;">
					...
					<div class="box box-info" style="border-radius: 12px;">
						...
						<!-- /.box-header -->
						<!-- form start -->
						<form class="form-horizontal" action="CategorySecondAdd.do" method="post"
							id="CategorySecondAdd" enctype="multipart/form-data">
							<div class="box-body">
								...
								<div class="form-group">
									...
									<div class="col-sm-7">
										<input  type="text" class="form-control"
											id="name" name="name" placeholder="不能为空">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-7">
										<input type="text" class="form-control"
											id="alias" name="alias" placeholder="不能为空">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-7">
										<input type="text" class="form-control"
											id="sort" name="sort" placeholder="请在1，2中输入一个数字">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-7">
										<textarea name="desca" class="col-sm-12" style="resize:none;" ></textarea>
									</div>
								</div>
