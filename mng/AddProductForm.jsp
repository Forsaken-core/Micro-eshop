			...
			<section class="content">
				...
				<div class="col-md-12" style="float:left;">
					...
					<div class="box box-info" style="border-radius: 12px;">
						...
						<!-- /.box-header -->
						<!-- form start -->
						<form class="form-horizontal" action="addproduct.do" method="post" id="addproduct" enctype="multipart/form-data">
							<div class="box-body">
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input style="width: 60%;" type="text" class="form-control"
											id="name" name="name" placeholder="请输入商品名称">
									</div>
								</div>
								...
								<div class="form-group">
										...
										<div class="col-sm-3">
											<select name="p_id1" id="cate_id1" class="form-control" onChange="test()">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<div>
											<select style="width: 60%;" name="supplier_id" id="supplier_id" class="form-control" >
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input style="width: 60%;" type="text" class="form-control"
											name="introduction" placeholder="请输入商品简述介绍">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input style="width: 60%;" type="text" class="form-control"
											name="inventory" placeholder="请输入商品库存">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input style="width: 60%;" type="text" class="form-control"
											name="price" placeholder="请输入商品进价(最多两位小数)">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input style="width: 60%;" type="text" class="form-control"
											name="sale_price" placeholder="请输入商品售价(最多两位小数)">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input style="width: 60%;" type="text" class="form-control"
											name="habitat" placeholder="请输入商品产地">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input style="width: 60%;" type="text" class="form-control"
											name="special_explanation" placeholder="请输入商品特殊说明">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input style="width: 60%;" type="text" class="form-control"
											name="weight" placeholder="请输入商品重量">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<div>
											<select style="width: 60%;" name="model" id="model" class="form-control" >
												<c:forEach items="${modellist }" var="m" >
													<option value="${m.mode_style }">${m.mode_style }</option>
												</c:forEach>
											</select>
										</div>
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input style="width: 60%;" type="text" class="form-control"
											name="adaptation_people" placeholder="请输入商品适用人群">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input style="width: 60%;" type="text" class="form-control"
											name="activity_number" placeholder="请输入参加活动数量">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input style="width: 60%;" type="text" class="form-control"
											name="activity_count" placeholder="参加活动价格">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input style="width: 60%;" type="text" class="form-control"
											name="start_buy_count" placeholder="请输入商品起购数量">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input style="width: 60%;" type="text" class="form-control"
											name="consignment" placeholder="请输入商品发货地点">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input style="width: 60%;" type="text" class="form-control"
											name="market_price" placeholder="请输入其他平台价格">
									</div>
								</div>
								...
								<div class="form-group">
										...
										<div class="col-sm-10">
											...
											<div class="input-group">
												...
												<input style="width: 58%;" type="text" name="quality_time" class="form-control" id="timktask" />
											</div>
										</div>
								</div>
								...
								<div class="form-group">
										...
										<div class="col-sm-6">
											<!--富文本编辑器控件-->
											<textarea id="description" name="description" rows="15" cols="70" class="form-control"></textarea>
										</div>
								</div>
								...
								<div class="form-group">
										...
										<div class="col-sm-10">
											...
											<div class="input-group">
												<span class="input-group-addon"><i class="fa  fa-calendar"></i></span>
												<input style="width: 58%;" type="text" name="sale_time" class="form-control" id="timktask1" />
											</div>
										</div>
								</div>
